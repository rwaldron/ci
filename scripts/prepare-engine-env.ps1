...
.\node_modules\.bin\eshost --add "chakra" ch $Env:ESHOST_PATH_CHAKRA
.\node_modules\.bin\eshost --add "engine262" engine262 $Env:ESHOST_PATH_ENGINE262
.\node_modules\.bin\eshost --add "spidermonkey" jsshell $Env:ESHOST_PATH_SPIDERMONKEY
.\node_modules\.bin\eshost --add "v8" d8 $Env:ESHOST_PATH_V8
.\node_modules\.bin\eshost --add "xs" xs $Env:ESHOST_PATH_XS
